...
def get_args():
    ...
    parser.add_argument("--data_dir", default="data/out_of_scope", type=str)
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/out_of_scope.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["out_of_scope"]
