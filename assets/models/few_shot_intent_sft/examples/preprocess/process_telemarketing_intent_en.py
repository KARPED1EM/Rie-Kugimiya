...
def get_args():
    ...
    parser.add_argument(
        "--excel_file",
        default=(project_path / "telemarketing_intent_en.xlsx").as_posix(),
        type=str
    )
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/telemarketing_intent_en.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["telemarketing_intent_en"]
    ...
    with open(args.output_file, "w", encoding="utf-8") as f:
        for i, row in tqdm(df.iterrows(), total=len(df)):
            ...
            row = {
                ...
                "label": label,
                # "intents": labels,
                "data_source": "telemarketing_intent_en",
