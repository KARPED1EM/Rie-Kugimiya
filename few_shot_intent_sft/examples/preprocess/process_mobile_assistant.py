...
def get_args():
    ...
    parser.add_argument("--dataset_path", default="dipesh/Intent-Classification-large", type=str)
    parser.add_argument(
        "--dataset_cache_dir",
    ...
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/mobile_assistant.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["mobile_assistant"]
