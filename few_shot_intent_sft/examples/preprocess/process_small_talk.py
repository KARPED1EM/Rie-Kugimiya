...
def get_args():
    ...
    parser.add_argument("--data_file", default="data/small_talk/Small_talk_Intent.csv", type=str)
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/small_talk.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["small_talk"]
...
def main():
    ...
    for i, row in df.iterrows():
        ...
        label = row["Intent"]
        label = label.lower()
        if not str(label).startswith("smalltalk_"):
