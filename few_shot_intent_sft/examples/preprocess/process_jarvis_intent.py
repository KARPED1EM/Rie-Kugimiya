...
def get_args():
    ...
    parser.add_argument("--data_file", default="data/jarvis_intent/Dataset-train.csv", type=str)
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/jarvis_intent.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["jarvis_intent"]
