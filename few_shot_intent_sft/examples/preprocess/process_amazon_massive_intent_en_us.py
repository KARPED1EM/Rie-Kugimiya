...
def get_args():
    ...
    parser.add_argument("--dataset_path", default="SetFit/amazon_massive_intent_en-US", type=str)
    parser.add_argument(
        "--dataset_cache_dir",
    ...
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/amazon_massive_intent_en_us.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["amazon_massive_intent_en_us"]
        ...
        for k, v in dataset_dict.items():
            for sample in tqdm(v):
                ...
                row = {
                    ...
                    "label": label,
                    # "intents": labels,
                    "data_source": "amazon_massive_intent_en_us",
                    "split": k
                }
