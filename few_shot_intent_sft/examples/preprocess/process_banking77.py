...
def get_args():
    ...
    parser.add_argument("--dataset_path", default="banking77", type=str)
    parser.add_argument(
        "--dataset_cache_dir",
    ...
    parser.add_argument(
        "--output_file",
        default=(project_path / "data/banking77.jsonl"),
        type=str
    )
...
label_map = DatasetLabels.label_map["banking77"]
